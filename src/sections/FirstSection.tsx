...
const FirstSection: React.FC = () => {
    return (
        <>
        <div className="w-screen h-screen bg-light-primary dark:bg-dark-primary">

            <div className="w-screen md:w-3/6 h-screen flex items-center justify-center flex-row md:flex-col">
                <div className="w-4/5 md:w-3/5 flex flex-col items-start justify-center">
                    <p className="h1 font-medium mb-2"> Ícaro Queiroz </p>
                    <p className="h1 font-light text-light-main dark:text-dark-main hidden md:flex"> &lt;Desenvolvedor&frasl; &gt; </p>
                    <p className="h1 font-light text-light-main dark:text-dark-main flex md:hidden"> &lt;Developer&frasl; &gt; </p>
