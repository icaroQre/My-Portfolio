const SVGmongo = ({...props} : React.SVGProps<SVGSVGElement>) => {
    return (
        <svg width="51" height="50" viewBox="0 0 51 50" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        <path d="M26.3023 46.8751L25.1289 46.486C25.1289 46.486 25.2851 40.5485 23.1367 40.1313C21.7305 38.4938 23.3445 -29.7765 28.4851 39.8985C27.5098 40.3933 26.7635 41.2459 26.4023 42.2782C26.2088 43.8028 26.1752 45.3435 26.3023 46.8751Z" fill="url(#paint0_linear_371_6)"/>
        <path d="M26.9366 41.139C30.061 38.7871 32.4537 35.5968 33.8366 31.9388C35.2196 28.2809 35.536 24.3056 34.7491 20.475C32.4522 10.3421 27.0132 7.01089 26.4272 5.73901C25.9217 4.94703 25.4902 4.11016 25.1382 3.23901L25.571 31.4718C25.571 31.4718 24.6741 40.1 26.9366 41.139Z" fill="url(#paint1_linear_371_6)"/>
